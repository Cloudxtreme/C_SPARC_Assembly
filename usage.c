...
usage( const char * programName ) {
  ...
  // Call fprintf() to print to stderr  and pass in parameters correctly
 (void) fprintf( stderr, STR_USAGE, programName, MIN_HR, HR_OFFSET, MIN_MINUTE,
                 MINUTE_OFFSET,MIN_SEC, SEC_OFFSET, MIN_INTERVAL, MAX_INTERVAL,
                 DEF_INTERVAL, MIN_TICKS, MAX_TICKS, DEF_TICKS );
}
